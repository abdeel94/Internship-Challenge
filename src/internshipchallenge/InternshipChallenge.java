                ...
                switch (opcion) {
                    ...
                    case 1: // 
                        ...
                        if (largoLista > 0) {
                            ...
                            System.out.println("La lista no ha podido ser creada, por favor ingrese un número válido.");
                        }
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        if (lista1.getListaNums().size() > 0) {
                            ...
                            System.out.println("2- Java Parallel Sort");
                            System.out.println("3- Java Quick Sort");
                            System.out.println("4- Java Heap Sort");
                            System.out.println("5- Java Bubble Sort");
                            System.out.print("\nIngrese su opción: ");
                            opt = scan.nextInt();
